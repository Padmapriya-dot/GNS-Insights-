      ...
      <div className="mx-auto max-w-[1400px] px-4 py-5 sm:px-6 lg:px-8">
        ...
        <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
          <div className="flex items-center gap-2">
            <h1 className="text-[22px] font-semibold tracking-tight text-[#1a1a1f]">Products</h1>
          ...
          >
            <span className="grid h-8 w-8 place-items-center rounded-full" style={{ background: YELLOW }}>
              <Building2 className="h-4 w-4 text-[#1a1a1f]" />
            </span>
            {company}
