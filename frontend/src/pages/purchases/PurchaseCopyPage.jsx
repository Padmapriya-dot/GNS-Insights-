  ...
  return (
    <div className="space-y-4 pb-8">
      <div className="no-print flex flex-wrap items-center justify-between gap-3 rounded-xl border border-slate-200 bg-white px-4 py-3 shadow-sm">
        <Link to="/purchases" className="text-sm font-semibold text-teal-700 hover:underline">
          ← Back to Purchases
        </Link>
        <div className="flex flex-wrap items-center gap-2">
          ...
          <Link to={`/purchases/${id}/edit`} className="inline-flex items-center gap-1.5 rounded-lg bg-teal-600 px-3 py-1.5 text-sm font-medium text-white hover:bg-teal-700">
            Edit Purchase
          </Link>
        </div>
      </div>
