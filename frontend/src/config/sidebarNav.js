...
export const SIDEBAR_NAV = [
  ...
  },
  {
    ...
    children: [
      ...
      { label: "Expense Settings", to: "/settings/expense-settings", module: "settings" },
      { label: "Sector Settings", to: "/settings/sector-settings", module: "settings" },
      { label: "Inventory Settings", to: "/settings/inventory-settings", module: "settings" },
      { label: "Merge Products", to: "/settings/merge-products", module: "settings" },
      { label: "Merge Buyers", to: "/settings/merge-buyers", module: "settings" },
      { label: "Merge Sellers", to: "/settings/merge-sellers", module: "settings" },
      { label: "Prefix Management", to: "/settings/prefix-management", module: "settings" },
