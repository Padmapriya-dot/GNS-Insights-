...
/** Lucide icons for ERP dashboard KPI ids — semantic, distinct per metric. */
export const KPI_ICONS = {
  "total-orders": FileStack,
  "today-production": Factory,
  "machines-running": Cpu,
  ...
  "total-employees": UserRound,
  "active-alerts": ShieldAlert,
  "total-sales-orders": ShoppingBag,
  "pending-sales-orders": Clock3,
